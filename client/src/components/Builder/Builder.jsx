      ...
      <div className="col l6 grey clearfix Builder">
        <Pager paginate="dots">
          ...
          <div className="characterAbilities">
            ...
            <label className="black-text bold" htmlFor="strength">Strength</label>
            <input className="input-field grey lighten-2" type="text" value={this.props.character.Stats[0]} name="strength" /> 
            <label className="black-text bold" htmlFor="constitution">Constitution</label>
            <input className="input-field grey lighten-2" type="text" value={this.props.character.Stats[1]} name="constitution" /> 
            <label className="black-text bold" htmlFor="dexterity">Dexterity</label>
            <input className="input-field grey lighten-2" type="text" value={this.props.character.Stats[2]} name="dexterity" /> 
            <label className="black-text bold" htmlFor="intelligence">Intelligence</label>
            <input className="input-field grey lighten-2" type="text" value={this.props.character.Stats[3]} name="intelligence" /> 
            <label className="black-text bold" htmlFor="wisdom">Wisdom</label>
            <input className="input-field grey lighten-2" type="text" value={this.props.character.Stats[4]} name="wisdom" /> 
            <label className="black-text bold" htmlFor="charisma">Charisma</label>
            <input className="input-field grey lighten-2" type="text" value={this.props.character.Stats[5]} name="charisma" /> 
